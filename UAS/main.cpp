...
void TampilkanJudul3(int jumlahBarang[3], string namaBarang[3], string satuanBarang[3], double hargaBarang[3]) {
    cout << "\n----------------------------------------------------------------------------------------------------------";
    cout << "\nNO\tJumlah\t\tNama Barang\t\t\tSatuan\t\tHarga (Rp)\t\tBiaya (Rp)";
    cout << "\n----------------------------------------------------------------------------------------------------------";
    int nomor = 1;
    double biayaPerBarang = 0, totalBiaya = 0;
